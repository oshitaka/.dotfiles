" Vim Color File
" Name:       cyberpunk.vim
" Maintainer: https://github.com/oshitaka
...
" < https://github.com/joshdick/cyberpunk.vim/blob/master/README.md >
" for more information.)
if !exists("g:cyberpunk_termcolors")
  let g:cyberpunk_termcolors = 256
endif

let g:cyberpunk_terminal_italics = 1
" Not all terminals support italics properly. If yours does, opt-in.
if !exists("g:cyberpunk_terminal_italics")
  let g:cyberpunk_terminal_italics = 0
endif
...
function! s:h(group, style)
  if g:cyberpunk_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:cyberpunk_termcolors == 16
...
let s:red = { "gui": "#FF0000", "cterm": "210", "cterm16": "1" } " Alternate cterm: 168
let s:dark_red = { "gui": "#F02C35", "cterm": "203", "cterm16": "9" }

let s:green = { "gui": "#00FF00", "cterm": "191", "cterm16": "2" }

let s:yellow = { "gui": "#FFFC4C", "cterm": "221", "cterm16": "3" }
let s:dark_yellow = { "gui": "#E7C630", "cterm": "214", "cterm16": "11" }
...
let s:white = { "gui": "#BDC3C7", "cterm": "231", "cterm16" : "16" }
